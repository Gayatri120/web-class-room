...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item">
			<div class="fill" style="background-image:url('images/h1.png');"></div>
			<div class="carousel-caption">
			<a href="loginlinkadmin"><h2 style="color: white;"> Making Learning Easy</h2>
			</div>
		</div>
		<div class="item active">
			<div class="fill" style="background-image:url('images/h3.png');"></div>
			<div class="carousel-caption">
				<a href="registrationform"><h2 style="color: white;">Register Today</h2></a>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/h2.jpeg');"></div>
			<div class="carousel-caption">
...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “WebClassroom” Website (web based application) is useful for the
							students, faculty, guest whom ever likes to learn from web using E-Learn
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">WEB-CLASSROOM</h2>
		</div>
		<div class="col-md-6">
			<p>The WEB-CLASSROOM by <strong>GAYATRI PATIL & TUSHAR PAWAR</strong> includes:</p>
			<ul>
		...
		<div class="col-md-6">
			<img class="img-responsive" src="images/T1.jpeg" alt="">
		</div>
	</div>
